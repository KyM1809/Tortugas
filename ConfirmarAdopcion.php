		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-10 offset-1">
					<p align="center">
						Presione el boton para confirmar y proceder con la adopcion.
					</p>
				</div>
				<div class="col-12" align="center">
					<h3>
						<form action="php/Nido.php" method="POST">
							<input type="hidden" name="Id" value="2">
							<input type="hidden" name="IdNido" value="<?php echo $_POST['IdNido']; ?>">
							<button type="submit" class="btn btn-outline-warning btn-lg">Confirmar</button>
						</form>
					</h3>
				</div>
			</div>
